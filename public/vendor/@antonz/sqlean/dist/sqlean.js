...
var sqlite3InitModule = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    var wasmBinaryFile;
    if (Module["locateFile"]) {
      wasmBinaryFile = "sqlean.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("sqlean.wasm", import.meta.url).href;
    }
    ...
    Module.postRun.push(function(Module2) {
      ...
      globalThis.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
        ...
        const config = Object.assign(/* @__PURE__ */ Object.create(null), {
          exports: void 0,
          memory: void 0,
          bigIntEnabled: (() => {
      ...
      globalThis.WhWasmUtilInstaller = function(target) {
        ...
        const __xArgString = function(v2) {
          if ("string" === typeof v2)
            return target.scopedAllocCString(v2);
      ...
      globalThis.Jaccwabyt = function StructBinderFactory(config) {
        ...
        Object.defineProperties(StructType, {
          ...
          hasExternalPointer: rop((v2) => v2 instanceof StructType && !!v2[xPtrPropName]),
          memberKey: __memberKeyProp
        });
        ...
        const makeMemberWrapper = function f(ctor, name, descr) {
          ...
          if (descr.readOnly) {
            ...
            prop.set = function(v2) {
              ...
              new DataView(heap().buffer, this.pointer + descr.offset, descr.sizeof)[f._.setters[sigGlyph]](0, f._.sw[sigGlyph](v2), isLittleEndian);
            };
          }
        ...
        ;
        {
          ...
          capi.sqlite3_prepare_v3 = function f(pDb2, sql, sqlLen, prepFlags, ppStmt, pzTail) {
            ...
            switch (typeof xSql) {
              ...
              case "number":
                return __prepare.full(pDb2, xSql, xSqlLen, prepFlags, ppStmt, pzTail);
              default:
                return util.sqlite3__wasm_db_error(
                  pDb2,
                  capi.SQLITE_MISUSE,
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        sqlite3.version = { "libVersion": "3.47.0", "libVersionNumber": 3047e3, "sourceId": "2024-10-21 16:30:22 03a9703e27c44437c39363d0baf82db4ebc94538a0f28411c85dda156f82alt1", "downloadVersion": 347e4 };
      });
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        const toss = (...args) => {
          throw new Error(args.join(" "));
        ...
        Stmt.prototype = {
          ...
          bind: function() {
            ...
            if ("object" === typeof arg && !util.isBindableTypedArray(arg)) {
              ...
              Object.keys(arg).forEach((k) => bindOne(
                this,
                k,
        ...
        vtab.setupModule = function(opt) {
          ...
          try {
            ...
            for (const e of Object.entries({
              ...
              const k = e[0], v2 = e[1];
              if (true === methods[k])
                methods[k] = methods[v2];
              else if (true === methods[v2])
                methods[v2] = methods[k];
            }
        ...
        const installOpfsVfs = function callee(options) {
          if (!globalThis.SharedArrayBuffer || !globalThis.Atomics) {
            return Promise.reject(
              new Error("Cannot install OPFS: Missing SharedArrayBuffer and/or Atomics. The server must emit the COOP/COEP response headers to enable those. See https://sqlite.org/wasm/doc/trunk/persistence.md#coop-coep")
            );
        ...
        class OpfsSAHPool {
          ...
          async addCapacity(n) {
            for (let i = 0; i < n; ++i) {
              ...
              const h = await __privateGet(this, _dhOpaque).getFileHandle(name, { create: true });
          ...
          async removeVfs() {
            ...
            try {
              ...
              await __privateGet(this, _dhVfsParent).removeEntry(
                __privateGet(this, _dhVfsRoot).name,
                { recursive: true }
              );
...
var toExportForESM = function() {
  ...
  const initModuleState = globalThis.sqlite3InitModuleState = Object.assign(/* @__PURE__ */ Object.create(null), {
...
var sqlean_default = sqlite3InitModule;
export {
  sqlean_default as default
};

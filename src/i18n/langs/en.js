...
export default {
  ...
  currencyFormDecimalPlacesHelpText: 'This application uses smallest unit of the currency (e.g., cents for USD) for calculations. Decimal places determine how to properly display the currency.',
  currencyFormDecimalPlacesLabel: 'Decimal Places',
  currencyFormDecimalPlacesPlaceholder: 'Decimal places of smallest unit of the currency (e.g., 2 for cents)',

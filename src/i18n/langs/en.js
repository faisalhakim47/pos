...
export default {
  ...
  journalEntryCtaDraftLabel: 'Save as Draft',
  journalEntryCtaDraftProgressLabel: 'Saving Journal Entry...',
  journalEntryCtaPostLabel: 'Post Immediately',
  journalEntryCtaPostProgressLabel: 'Posting Journal Entry...',
  journalEntryCurrencySelectPlaceholder: 'Select a currency',
  ...
  journalEntryLineAccountSelectPlaceholder: 'Select an account',
  journalEntryLineAmountInputPlaceholder: '0.00',
  journalEntryLineCreditInputLabel: 'Credit amount for line',
  journalEntryLineCtaAddLabel: 'Add Line',
  journalEntryLineCtaRemoveLabel: 'Remove line',
  journalEntryLineDebitInputLabel: 'Debit amount for line',
